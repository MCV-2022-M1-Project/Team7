...
aveMAE, gt2rs_mae = Measures.compute_ave_MAE_of_methods(gt_name_list,rs_dir_lists)
print('\n')
...
PRE, REC, FM, gt2rs_fm = Measures.compute_PRE_REC_FM_of_methods(gt_name_list,rs_dir_lists,beta=0.3)
...
Measures.plot_save_pr_curves(0,PRE, # numpy array (num_rs_dir,255), num_rs_dir curves will be drawn
...
Measures.plot_save_fm_curves(0,FM, # numpy array (num_rs_dir,255), num_rs_dir curves will be drawn
